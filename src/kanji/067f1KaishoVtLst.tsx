...
const Icon067f1KaishoVtLst = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      ...
      <text transform="translate(51.25 60.13)">{"7"}</text>
      <text transform="translate(43.75 86.5)">{"8"}</text>
      <text transform="translate(63.75 49.63)">{"9"}</text>
    </g>
  </svg>
);

export default Icon067f1KaishoVtLst;
