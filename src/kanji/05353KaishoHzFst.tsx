...
const Icon05353KaishoHzFst = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      <text transform="translate(59 21.5)">{"1"}</text>
      <text transform="translate(45 11.5)">{"2"}</text>
...
export default Icon05353KaishoHzFst;
