...
const Kanji命 = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      ...
      <text transform="translate(61.5 17.5)">{"2"}</text>
      <text transform="translate(42.5 37.5)">{"3"}</text>
      <text transform="translate(15.75 64.63)">{"4"}</text>
      <text transform="translate(26.5 52.63)">{"5"}</text>
      <text transform="translate(29.5 70.63)">{"6"}</text>
      <text transform="translate(58.5 51.47)">{"7"}</text>
      <text transform="translate(51.75 66.13)">{"8"}</text>
    </g>
  </svg>
);

export default Kanji命;
