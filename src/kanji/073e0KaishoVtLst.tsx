...
const Icon073e0KaishoVtLst = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      ...
      <text transform="translate(3.75 51.13)">{"2"}</text>
      <text transform="translate(3.75 81.5)">{"3"}</text>
...
export default Icon073e0KaishoVtLst;
