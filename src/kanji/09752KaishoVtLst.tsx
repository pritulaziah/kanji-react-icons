...
const Icon09752KaishoVtLst = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      ...
      <text transform="translate(25.5 35.5)">{"2"}</text>
      <text transform="translate(5.5 48.5)">{"3"}</text>
      <text transform="translate(42.75 9.5)">{"4"}</text>
...
export default Icon09752KaishoVtLst;
