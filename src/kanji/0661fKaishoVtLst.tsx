...
const Icon0661fKaishoVtLst = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      ...
      <text transform="translate(27.75 78.13)">{"7"}</text>
      <text transform="translate(14.25 96.13)">{"8"}</text>
      <text transform="translate(44.75 51.5)">{"9"}</text>
    </g>
  </svg>
);

export default Icon0661fKaishoVtLst;
