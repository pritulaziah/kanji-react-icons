...
const Icon05178KaishoVtLst = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      ...
      <text transform="translate(33.75 48.13)">{"3"}</text>
      <text transform="translate(17.5 69.5)">{"4"}</text>
      <text transform="translate(33.5 16.5)">{"5"}</text>
      <text transform="translate(55.5 13.5)">{"6"}</text>
...
export default Icon05178KaishoVtLst;
