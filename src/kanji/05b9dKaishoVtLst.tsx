...
const Icon05b9dKaishoVtLst = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      ...
      <text transform="translate(24.75 68.5)">{"5"}</text>
      <text transform="translate(14.5 93.13)">{"6"}</text>
...
export default Icon05b9dKaishoVtLst;
