...
const Icon05b99KaishoVtLst = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      ...
      <text transform="translate(35.25 70.63)">{"6"}</text>
      <text transform="translate(35.25 88.55)">{"7"}</text>
      <text transform="translate(42.5 39.5)">{"8"}</text>
    </g>
  </svg>
);

export default Icon05b99KaishoVtLst;
