...
const Icon05c4aKaishoVtLst = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      ...
      <text transform="translate(43.5 72.13)">{"6"}</text>
      <text transform="translate(44.25 90.05)">{"7"}</text>
      <text transform="translate(51.5 46.5)">{"8"}</text>
    </g>
  </svg>
);

export default Icon05c4aKaishoVtLst;
