...
const Icon08cbcKaishoHzFst = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      ...
      <text transform="translate(75.5 37.5)">{"8"}</text>
      <text transform="translate(59.5 13.5)">{"9"}</text>
...
export default Icon08cbcKaishoHzFst;
