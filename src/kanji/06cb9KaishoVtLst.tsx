...
const Icon06cb9KaishoVtLst = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      ...
      <text transform="translate(49.5 59.5)">{"6"}</text>
      <text transform="translate(49.5 81.13)">{"7"}</text>
      <text transform="translate(55.5 17.5)">{"8"}</text>
    </g>
  </svg>
);

export default Icon06cb9KaishoVtLst;
