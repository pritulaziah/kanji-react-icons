...
const Katakanaジ = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      ...
      <path d="M33 85c3.62 1.62 6.5.88 10.38-1.38C61.19 73.28 75.75 59.75 89.5 40.75" />
      <path d="M78.5 18.98c2.85 1.78 6.21 5.47 8.03 8.65" />
      <path d="M85.25 14.38c2.93 1.57 6.39 4.83 8.25 7.63" />
    </g>
    <g
      style={{
        fontSize: 8,
