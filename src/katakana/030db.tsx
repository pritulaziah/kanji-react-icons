...
const Icon030db = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    >
      ...
      <path d="M53.75 17.12c1.38 1.88 1.38 4.5 1.38 7.38s-.12 46.62-.12 51.88c0 23.12-6.25 11.25-9.75 9.62M27.38 59.38C27.88 68.63 26 76 21 81.26M73.25 52.75c10.88 9.63 15.5 17.63 16.63 24.87" />
    </g>
    <g
      style={{
        fontSize: 8,
