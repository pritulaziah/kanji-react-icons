...
const Icon030e2 = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={109} height={109} {...props}>
    ...
    >
      <path d="M27.88 26.19c2.5 1.19 4.33 1.6 7.45 1.35 11.55-.91 21.93-2.16 32.79-3.93 2.62-.42 6.27-.41 8.39-.17M17.5 54.38c2.62 1 4.78 1.45 9.12.75C46.88 51.88 60.5 49.75 78.26 49c3.75-.16 7.38.25 11.12.88" />
