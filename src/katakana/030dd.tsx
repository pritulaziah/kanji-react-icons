...
const Icon030dd = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={109} height={109} {...props}>
    ...
    >
      ...
      <path d="M53.75 17.12c1.38 1.88 1.38 4.5 1.38 7.38s-.12 46.62-.12 51.88c0 23.12-6.25 11.25-9.75 9.62M27.38 59.38C27.88 68.63 26 76 21 81.26M73.51 53c10.87 9.62 15.5 17.62 16.62 24.88M79.75 25.62c-9.62 0-9.25-14.25 0-14.25 9.76.01 9.5 14.25 0 14.25" />
    </g>
    <g
      style={{
        fontSize: 8,
